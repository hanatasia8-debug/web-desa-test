...
export function MapLegend({ categories, selectedCategoryIds }: MapLegendProps) {
  ...
  return (
    <div className="glass-panel border-outline-variant/30 absolute bottom-6 left-1/2 z-20 flex max-w-[90vw] -translate-x-1/2 flex-wrap items-center justify-center gap-6 rounded-full border px-6 py-3 shadow-xl">
